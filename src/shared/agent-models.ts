...
export const LEGACY_MODEL_ALIASES: Partial<Record<AgentBackendId, Record<string, string>>> = {
  'cursor-agent': {
    ...
    'claude-opus-4-7-high': 'claude-opus-4-8-thinking-high',
...
export const AGENT_MODEL_CATALOG: Record<AgentBackendId, AgentModelEntry[]> = {
  ...
  'cursor-agent': [
    ...
    { id: 'gpt-5.2-codex', label: 'GPT-5.2 Codex', strength: 'Code generation & review', tier: 'standard', multiplier: 'medium', yoloMode: 'Yes', fleetMode: 'Partial (Composer)', preferredFor: [] },
    ...
    { id: 'claude-sonnet-5-thinking-high', label: 'Claude Sonnet 5', strength: 'Latest Sonnet, deep reasoning', tier: 'standard', multiplier: '1×', yoloMode: 'Yes', fleetMode: 'Partial (Composer)', preferredFor: ['Planning'] },
    ...
    { id: 'claude-opus-4-8-thinking-high', label: 'Claude Opus 4.8', strength: "Anthropic's most powerful", tier: 'premium', multiplier: 'high', yoloMode: 'Yes', fleetMode: 'Partial (Composer)', preferredFor: [] },
